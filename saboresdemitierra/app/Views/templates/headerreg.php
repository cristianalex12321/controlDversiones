...
<nav class="bg-info navbar navbar-expand-lg navbar-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?=base_url("home/iniciarSesion")?>">Pedidos</a>
        </li>
        </ul>
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?=base_url("home/iniciarSesion")?>">Iniciar sesion</a>
                    <a class="dropdown-item" href="<?=base_url("home/formusuario")?>">Registrarse</a>
                </div>
            </li>
      </ul>
  </div>
